...
themeToggler.addEventListener("click", () => {
  ...
  const theme = document.body.classList.contains('dark-theme-variables') ? '1' : '0';
  themeToggler.querySelector("span:nth-child(1)").classList.toggle("active");
  themeToggler.querySelector("span:nth-child(2)").classList.toggle("active");
  localStorage.setItem('theme-in-user', theme);
});
if(localStorage.getItem('theme-in-user')) {
  if(parseInt(localStorage.getItem('theme-in-user')) === 1) {
    themeToggler.click();
  }
}
